...
class MealDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (mealId == null) {
      // Handle case where no mealId is passed.
      return Scaffold(
        appBar: AppBar(
    ...
    final selectedMealIndex =
        DUMMY_MEALS.indexWhere((meal) => meal.id == mealId);

    if (selectedMealIndex < 0) {
      // Handle case where mealId is not found.
      return Scaffold(
        appBar: AppBar(
          title: const Text('Error'),
        ),
    ...
    final selectedMeal = DUMMY_MEALS[selectedMealIndex];
    return Scaffold(
      appBar: AppBar(
